...
In this course you have a do-at-home quiz in the week following each Lab, so this solutions document will be released soon after the lab to allow you to use it, if you wish, when attempting the quiz. Additional feedback can always be added later to this document.

If you spot any typos please don't hesistate to let me know.
</div>
:::
...
Load birthweight data. (One source of the data is here https://github.com/neurospin/pystatsml/tree/master/datasets called birthwt.csv it's also on Moodle.)
...
Lower AIC indicates better model → **full model preferred**.
